            ...
            <div class="form-box">
                <el-form ref="form" :model="form" label-width="80px">
                    ...
                    <el-form-item label="新闻作者">
                        <el-input v-model="form.writer" style="width:46%" maxlength="10" show-word-limit></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="新闻内容">
                        <el-input type="textarea" rows="10" v-model="form.content" maxlength="300" show-word-limit></el-input>
                    </el-form-item>
                    <el-form-item label="新闻来源">
                        <el-input v-model="form.source" placeholder="http://……"></el-input>
                    </el-form-item>
                    <el-form-item>
