    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                >批量删除</el-button>
                <el-input v-model="query.title" placeholder="新闻标题" class="handle-input mr10"></el-input>
            ...
            >
                ...
                <el-table-column prop="title" label="新闻标题" width="450"></el-table-column>
                <el-table-column prop="reporter" label="新闻记者"></el-table-column>
                <el-table-column prop="source" label="新闻来源"></el-table-column>
                ...
                <el-table-column sortable prop="sum" label="浏览次数"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        saveEdit() {
            ...
            this.$set(this.newsData, this.idx, this.form);
        },
        // 分页导航
